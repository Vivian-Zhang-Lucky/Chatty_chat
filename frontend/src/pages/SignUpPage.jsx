  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <div
                className="size-12 rounded-xl bg-secondary flex items-center justify-center 
              group-hover:bg-accent/60 transition-colors"
              >
                <MessageSquare className="size-6 text-base-100" />
              </div>
      ...
      <AuthImagePattern
        ...
        subtitle="Stay connected with friends and family—protected by encryption."
      />
    </div>
  );
};
